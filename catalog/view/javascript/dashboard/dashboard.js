$(document).ready(function() {
    ...
    _.each([0, 1, 2, 3, 4, 5, 6], function(value) {
        funDaskboard.ajaxAnalytics($('td.analytics-tree[data-level=' + value + ']'), function(result) {
            _.has(result, 'success') && $('td.analytics-tree[data-level=' + value + ']').html(_.values(result)[0] + '<i class="fa fa-user" style="margin-left: 10px;"></i>');
    ...
    funDaskboard.ajaxGetR_Wallet(function(result) {
        _.has(result, 'success') && $('.r-wallet').html(_.values(result)[0] + ' USD');
    ...
    funDaskboard.ajaxGetC_Wallet(function(result) {
        _.has(result, 'success') && $('.c-wallet').html(_.values(result)[0] + ' USD');
