...
class ControllerAccountLogin extends Controller {
	...
	public function index() {
		...
		call_user_func_array("myCheckLoign", array($this)) && $this->response->redirect(HTTPS_SERVER . 'dashboard');
		!$this->request->get['route'] && $this->response->redirect(HTTPS_SERVER . 'login');
		...
		if (!empty($this->request->get['token'])) {
			...
			if ($customer_info && $this->customer->login($customer_info['email'], '', true)) {
				...
				$this->response->redirect(HTTPS_SERVER . 'dashboard');
			}
		}
		...
		if (isset($this->request->post['capcha'])) {
			$data['capcha'] = $this->request->post['capcha'];
		} else {
			$data['capcha'] = '';
		}
