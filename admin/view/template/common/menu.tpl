<ul id="menu">
  ...
  <li id="news" ><a href="<?php echo $simple_blog_article; ?>"><i class="fa fa-dashboard fa-fw"></i> <span><?php echo $text_simple_blog_article; ?></span></a></li>
   <li id="" ><a href="index.php?route=pd/pd/finish&token=<?php echo $_GET['token'];?>"><i class="fa fa-user fa-fw"></i> <span> PD Finish </span></a></li>
  <li id="news" ><a href="<?php echo $gd_menu; ?>"><i class="fa fa-dashboard fa-fw"></i> <span>GD</span></a></li>
  <li id="news" ><a href="<?php echo $phmenu; ?>"><i class="fa fa-dashboard fa-fw"></i> <span>PD</span></a></li>
  <?php /* ?>
